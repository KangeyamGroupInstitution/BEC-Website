...
router.get('/naac/feedback', otherController.showFeedbackForm);
router.get('/naac/grievances', otherController.showGrievancesPage);
router.get('/naac/annual', otherController.showAnnualPage);
